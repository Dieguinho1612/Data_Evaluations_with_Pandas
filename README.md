...
This repository contains evaluations of provided data, conducted using the Python 3 package Pandas for clients. The code used for the analysis was uploaded to this repository with the permission of the respective client for whom it was created. It should be noted that dummy data was used for illustration purposes. 
